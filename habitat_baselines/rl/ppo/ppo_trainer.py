...
class PPOTrainerNO(BaseRLTrainerNonOracle):
    ...
    def train(self) -> None:
        ...
        if self.config.CONTINUE_TRAINING is not None:
            print("Loaded model is", self.config.CONTINUE_TRAINING)
            # print(self.config.CONTINUE_TRAINING.split('_')[-7])
            # print(self.config.CONTINUE_TRAINING.split('_')[-8])
            update = int(self.config.CONTINUE_TRAINING.split('_')[-7])  # for count_checkpoints
            count_steps = int(self.config.CONTINUE_TRAINING.split('_')[-8])  # for count_checkpoints
